...
mv chewbaccca.txt luke_skywalker.txt han_solo.txt princess_leia.txt millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv death_star/millenium_falcon rebellion
# 5. darth_vader leaves the deatmvh_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt ..
